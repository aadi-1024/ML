...
data_X = data[["PassengerId", "Pclass", "Sex", "Age", "SibSp", "Fare"]]
...
nb_model = GaussianNB()
nb_model.fit(train_X[["Pclass", "Sex", "Age", "SibSp", "Fare"]], train_y)
...
# pred = nb_model.predict(val_X[["Pclass", "Sex", "Age", "SibSp", "Fare"]])
